...
import type { Annotation, AudioDomainStore, AudioFile, AudioUiStore, Label, Selection } from "@/types/audio";
...
export const useAudioDomainStore = create<AudioDomainStore>()(
  immer((set) => ({
    ...initialDomainState,
...
export const useAudioUiStore = create<AudioUiStore>()(
  immer((set) => ({
    ...initialUiState,
    // View
    setZoom: (zoom: number) =>
    ...
    toggleHotkeys: (open) =>
      set((state) => {
        state.showHotkeys = open ?? !state.showHotkeys;
      }),
